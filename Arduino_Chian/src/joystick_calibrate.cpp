...
//                 operation_status = chain.getJoystick16Adc(devices_list->devices[0].id, &xAdcValue, &yAdcValue);
//                 if (operation_status == CHAIN_OK) {
//                     count++;
//                     xSum = xSum + xAdcValue;
//                     ySum = ySum + yAdcValue;
...
//         chain_status_t operation_status;
//         if (devices_list->devices[0].device_type == 0x04) {
//             operation_status = chain.setJoystickMappedRange(devices_list->devices[0].id, mapRange, 8, &sta, 1);
//             if (operation_status == CHAIN_OK) {
//                 Serial.println("设置OK");
//                 delay(5000);
//             }
